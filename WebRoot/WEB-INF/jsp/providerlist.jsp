...
<div class="right">
		...
		<div>
			<label>供应商编码：</label> <input type="text"
				name="v_proCode" id="v_proCode" value="" readonly="readonly">
		</div>
		<div>
			<label>供应商名称：</label> <input type="text"
				id="v_proName" name="v_proName" value="" readonly="readonly">
		</div>
		<div>
			<label>联系人：</label> <input type="text" id="v_proContact" name="v_proContact"
				readonly="readonly" value="">
		</div>
		<div>
			<label>联系电话：</label> <input type="text" name="v_proPhone"
				id="v_proPhone" value="" readonly="readonly">
		</div>
		<div>
			<label>传真：</label> <input type="text" id="v_proFax"
				name="v_proFax" readonly="readonly">
		</div>
		<div>
			<label>描述：</label> <input name="v_proDesc"
				id="v_proDesc" value="" readonly="readonly">
		</div>
</div>
    </div>
</section>
